...
if __name__ == "__main__":
    ...
    generate_few_shot(dev_path=dev_path, out_path=few_shot_path, n_total=args.fewshot)

    # Run evaluation
    evaluator = Evaluator(dev_path)
    evaluator.run(schema_path=schema_path, db_name=db_name, few_shot_path=few_shot_path, limit=args.n)
